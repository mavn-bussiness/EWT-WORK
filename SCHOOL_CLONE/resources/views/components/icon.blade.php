...
@php
    $icons = [
        ...
        'people' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />',
        'school' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13" />',
...
<svg xmlns="http://www.w3.org/2000/svg" {{ $attributes->merge(['class' => 'inline-block ' . $class]) }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    @if(isset($icons[$name]))
        {!! $icons[$name] !!}
    @else
