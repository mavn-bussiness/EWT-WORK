            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="space-x-2">
                            <a href="{{ route('admin.events.edit', $schoolEvent->id) }}" class="inline-flex items-center px-4 py-2 bg-yellow-600 text-white rounded hover:bg-yellow-700 transition-colors">
                            ...
                            <form action="{{ route('admin.events.delete', $schoolEvent->id) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="inline-flex items-center px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 transition-colors" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <div class="bg-gray-50 p-4 rounded-md">
                            <div class="flex items-center mb-4">
                                ...
                                <h4 class="text-md font-medium text-gray-700">Event Info</h4>
                            </div>
                            <div class="ml-7">
                                <p class="text-gray-600 text-sm">Created: {{ $schoolEvent->created_at->format('M d, Y') }}</p>
                                <p class="text-gray-600 text-sm mt-1">Last Updated: {{ $schoolEvent->updated_at->format('M d, Y') }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-4 pt-4 border-t border-gray-200">
                        <a href="{{ route('admin.events.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-200 rounded-md text-gray-700 hover:bg-gray-300 transition-colors">
                            <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
