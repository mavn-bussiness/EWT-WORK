                ...
                <table class="aws-table min-w-full">
                    ...
                    @foreach ($assessments as $assessment)
                        <tr>
                            ...
                            <td class="text-sm text-[var(--aws-text-light)]">{{ $assessment->max_score }}</td>
                            <td class="text-sm text-[var(--aws-text-light)]">
                                <a href="{{ route('teacher.marks.create', $assessment->id) }}" class="text-[var(--aws-orange)] hover:text-[var(--aws-orange-hover)]">Record Marks</a>
                                <a href="{{ route('teacher.marks.edit', $assessment->id) }}" class="text-[var(--aws-green)] hover:text-[var(--aws-green)] ml-2">Edit Marks</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
