    ...
    <div class="aws-content">
        ...
        <div class="max-w-7xl mx-auto">
            <div class="aws-card p-6">
                ...
                <form action="{{ route('teacher.assignments.updateGrades', $assignment->id) }}" method="POST">
                    @csrf

                    <div class="mb-4">
                        <p class="text-[var(--aws-text-light)]"><strong>Class:</strong> {{ $assignment->class->name }}{{ $assignment->class->stream ? ' - ' . $assignment->class->stream : '' }}</p>
                        <p class="text-[var(--aws-text-light)]"><strong>Subject:</strong> {{ $assignment->subject->name }}</p>
                        <p class="text-[var(--aws-text-light)]"><strong>Max Score:</strong> {{ $assignment->max_score }}</p>
                    </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="aws-table min-w-full">
                            ...
                            @foreach ($studentAssignments as $studentAssignment)
                                <tr>
                                    <td class="text-sm text-[var(--aws-text-light)]">{{ $studentAssignment->student->user->name }}</td>
                                    ...
                                    <td class="text-sm text-[var(--aws-text-light)]">{{ $studentAssignment->grade ?? '-' }}</td>
                                    <td class="text-sm text-[var(--aws-text-light)]">
