            ...
            <div class="aws-card p-6">
                ...
                <form action="{{ route('teacher.assignments.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="title" id="title" class="aws-input" required>
                    </div>

                    <div class="mb-4">
                        <label for="description" class="aws-label">Description</label>
                        <textarea name="description" id="description" class="aws-textarea" required></textarea>
                    </div>

                    <div class="mb-4">
                        <label for="due_date" class="aws-label">Due Date</label>
                        <input type="date" name="due_date" id="due_date" class="aws-input" required>
                    </div>

                    <div class="mb-4">
                        <label for="max_score" class="aws-label">Max Score</label>
                        <input type="number" name="max_score" id="max_score" class="aws-input" required min="1">
                    </div>
